...
public class ServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        System.out.println(String.format("[%s] 执行 channelRead", Thread.currentThread().getName()));
        ...
        try {
            ...
            // 发送响应消息给客户端
            ctx.writeAndFlush(Unpooled.copiedBuffer(String.format("我是服务端，我收到你的消息啦~ 【】", msg), CharsetUtil.UTF_8));
        } finally {
            // 释放ByteBuf资源
